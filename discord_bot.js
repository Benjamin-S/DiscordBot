...
console.log("Starting DiscordBot\nNode version: " + process.version + "\nDiscord.io version: " + Discord.version);
...
bot.on("ready", function() {
      console.log("Logged in! Serving in " + _.size(bot.servers) + " servers");
      require("./plugins.js").init();
      console.log("type " + Config.commandPrefix + "help in Discord for a commands list.");
      bot.setPresence({
          status: 'online',
          game: {
            name: Config.commandPrefix + "help | " + _.size(bot.servers) + " Servers"
        	}
      });
		});
    ...
    bot.on("message", (msg) => checkMessageForCommand(msg, false)); bot.on("messageUpdate", (oldMessage, newMessage) => {
